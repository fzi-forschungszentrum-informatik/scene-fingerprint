...
class LL2XYProjector:
    def __init__(self, lat_origin, lon_origin):
        ...
        # self.p = pyproj.Proj(proj='tmerc', R='6378137',lat_0=lat_origin, lon_0=lon_origin)
...
def draw_map_without_lanelet(filename, axes, lat_origin, lon_origin):
    ...
    if len(unknown_linestring_types) != 0:
        print("Found the following unknown types, did not plot them: " + str(unknown_linestring_types))  # noqa
